...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "업무 추가 Request DTO")
public class AddTaskDto {

    @Schema(description = "업무명", example = "Make Service")
    @NotBlank(message = "업무명은 필수 입력 값 입니다.")
    private String taskName;

    @Schema(description = "업무 설명", example = "This is Making Service")
    @NotBlank(message = "업무 설명은 필수 입력 값 입니다.")
